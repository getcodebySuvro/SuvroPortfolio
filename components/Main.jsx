          ...
          '></div>
            ...
            <div className='z-[700] absolute mt-20'>
             ...
             <div className='flex  justify-center items-center m-auto max-w-[80%] p-3 '>
                ...
                <a href="https://www.linkedin.com/in/suvrojyoti-bhuniya-a497881b1" data-aos="fade-right" data-aos-delay="1000" target='_blank'>
                ...
                <a href="https://github.com/getcodebySuvro" data-aos="fade-right" data-aos-delay="800" target='_blank' >
                ...
                <a href="mailto:suvrojyotibhuniya@gmail.com" data-aos="fade-right" data-aos-delay="600" target='_blank'>
                <div className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer mx-5 bg-[#ebebeb] hover:text-[#7b28ff] hover:shadow-[#7b28ff] active:scale-[0.9]  dark:shadow-none dark:bg-[#7b28ff]/50 dark:hover:bg-[#7b28ff] dark:hover:text-white dark:text-white'>
                  <AiFillMail/>
                  </div>
                  </a>
                ...
                <a href="mailto:suvrojyotibhuniya@gmail.com"  data-aos="fade-right" data-aos-delay="400" >
                <div className='rounded-full shadow-lg  shadow-gray-400 p-3 cursor-pointer mx-5 bg-[#ebebeb] hover:text-[#7b28ff] hover:shadow-[#7b28ff] active:scale-[0.9]  dark:shadow-none dark:bg-[#7b28ff]/50 dark:hover:bg-[#7b28ff] dark:hover:text-white dark:text-white'>
                  <HiDocumentText/></div>
                </a>
